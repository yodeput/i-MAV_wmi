 ...
 */
public class VisitContinue extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {

    private static final String TAG = VisitContinue.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visit_continue);
        ...
        final String nama_pic = user.get("name");
        String email_pic = user.get("email");

        manager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        timerchrono = (Chronometer) findViewById(R.id.chronometer);
        ...
        String category = i.getStringExtra(TAG_CAT);
        String start = i.getStringExtra(TAG_STARTTIME);
        pic_name = i.getStringExtra(TAG_PIC);
        //GPS Loc Start
                ...
                if (!category.isEmpty() && !pic.isEmpty()) {
                    if (category.contains("Pilih")) {
                        ...
                        if (conType == "No Internet Connection") {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(VisitContinue.this);
                            View viewInflated = LayoutInflater.from(VisitContinue.this).inflate(R.layout.message_dialog,
                            ...
                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    pDialog = new ProgressDialog(VisitContinue.this);
                            ...
                            final AlertDialog.Builder builder = new AlertDialog.Builder(VisitContinue.this);
                            final View viewInflated = LayoutInflater.from(VisitContinue.this).inflate(R.layout.message_dialog_button,
                                    (ViewGroup) findViewById(android.R.id.content), false);
                            final TextView titletxt = (TextView) viewInflated.findViewById(R.id.title_txt);
                            final TextView messagetxt = (TextView) viewInflated.findViewById(R.id.message_txt);
                            ...
                            sms_checkin.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    AlertDialog.Builder builder2 = new AlertDialog.Builder(VisitContinue.this);
                                    View viewInflated = LayoutInflater.from(VisitContinue.this).inflate(R.layout.message_dialog,
                                            (ViewGroup) findViewById(android.R.id.content), false);
                                    final TextView titletxt = (TextView) viewInflated.findViewById(R.id.title_txt);
                                    final TextView messagetxt = (TextView) viewInflated.findViewById(R.id.message_txt);
    ...
    private void Notify(Boolean aucan, String site_name, String start_time) {
        ...
        if (start_time == "Selesai Aktivitas") {
            ...
            Notification.Builder builder = new Notification.Builder(VisitContinue.this);
            ...
            Intent intent = new Intent(getApplicationContext(), VisitContinue.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        isiData.setVisibility(View.VISIBLE);
                        timerchrono.setVisibility(View.VISIBLE);
                        timerchrono.start();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        timerchrono.setVisibility(View.GONE);
                        timerchrono.stop();
    ...
    public void onBackPressed() {
        ...
        if (timerchrono.getVisibility() == View.GONE) {
            String URL = URL_OUTSTANDING;
            Intent intent = new Intent(VisitContinue.this, outstandingVisit.class);
            updateoutstandingVisit();
            intent.putExtra("pic", pic_name);
    ...
    private void updateoutstandingVisit() {
        ...
        try {
            ...
            URL_OV = ipport + URL_OUTSTANDING + tt;
            //Log.e("a", URL_FINAL);
        } catch (Exception e) {
            return;
        }
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    try {
                        FileWriter file = new FileWriter("/data/data/" + getApplicationContext().getPackageName() + "/databases/" + "outstandingVisit.json");
